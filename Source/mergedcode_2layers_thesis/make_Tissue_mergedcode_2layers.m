% make_Tissue_mergedcode_2layers.m
% myname = skinvessel_mergedcode_2layers % name for files
...
%
%   Uses
%       make_TissueList_mergedcode_2layers.m
%
%   To use, 
%       1. Prepare make_TissueList_mergedcode_2layers.m
%       so that it contains the tissue types desired.
%       2. Specify the USER CHOICES.
%       2. Run this program, make_Tissue_mergedcode_2layers.m
%
%       
clear
format compact
